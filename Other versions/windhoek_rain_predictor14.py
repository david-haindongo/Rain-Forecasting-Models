...
Version: 12.9 (Improved model selection, balanced validation, HMM diagnostics)
License: MIT
"""
...
class WindhoekRainPredictorV12:
    ...
    def print_header(self) -> None:
        print("\n" + "=" * 80)
        print("WINDHOEK RAIN PREDICTOR v12.9".center(80))
        print("=" * 80)
    ...
    def engineer_features_expert(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        if min_len > 500:
            ...
            # (full feature engineering code unchanged)
            pass
        # Time-based features
...
# ============================================================================
def main():
    logging.info("Starting Windhoek Rain Predictor v12.9")
    try:
